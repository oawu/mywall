<t2>列表 <?php echo $feature_name_2; ?></t2>
...
<form id="search_form" method="post" action="<?php echo $search_url; ?>" style='<?php echo $has_append_condition ? '' : 'display: none;';?>'>
  <table class='search_list'>
    <tbody>
      ...
      <tr><th>內容</th><td><input type='text' name='message' value="<?php echo $message; ?>" placeholder='請輸入要搜尋的 內容...' class='form-control' x-webkit-speech/></td></tr>
      </td></tr>
      <tr><th>是否同步FB</th><td>
